                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="input-block mb-3">
                            ...
                            <input type="text" class="form-control " name="university_location" value="" placeholder="Location" >
                        ...
                        <div class="col-lg-12">
                            <div class="input-block mb-3">
                                ...
                                <input type="text" class="form-control  google-iframe-url" name="map_location" placeholder="Enter the Google Maps iframe URL here" value="">
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input type="text" class="form-control " name="university_name" value="" maxlength="200" placeholder="University Name" />
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input type="hidden" name="university_id" class="university_id" value="">
                        <input type="tel" class="form-control " name="phone_number"  pattern="[0-9]{10}" value=""  placeholder=" Phone no" id="basicpill-vatno-input"/>
                    ...
                    <div class="col-lg-4">
                        <div class="input-block mb-3">
                          ...
                          <input type="email" class="form-control " placeholder="email" name="email" value="" maxlength="255" />
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input type="number" class="form-control " maxlength="200" value="" name="founded_in" placeholder="Founded in" />
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input type="number" class="form-control " placeholder="total student" name="total_students" value="" />
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input type="number" class="form-control "  name ="international_students"  maxlength="200"  value=""  placeholder="international student" />
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input type="text" class="form-control " name="size_of_campus"  value="" placeholder="size of campus" maxlength="200"/>
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input type="text" class="form-control " name="male_female_ratio" value=""  maxlength="200" placeholder="male female ratio" />
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input type="text" class="form-control " name="faculty_student_ratio" value="" placeholder="Faculty Student Ratio" maxlength="200" />
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input type="number" class="form-control "  name="expense_amount" maxlength="30" value="" placeholder=" expense_amount" >
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input type="number" class="form-control " name="financial_aid" value="" placeholder="Student Recruing Financial Aid (%)" >
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input  name="website2" type="text" class="form-control " value="" placeholder="Accomodation Website" autocomplete="website2">
                    ...
                    <div class="col-lg-4">
                        <div class="input-block mb-3">
                          ...
                          <input  name="application_cost" type="number" class="form-control " value="" placeholder="Application Cost/Registration Fees" autocomplete="application_cost">
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input id="lead-fafsa_code" name="fafsa_code" type="number" class="form-control " placeholder="FAFSA Code" autocomplete="fafsa_code"  value="">
                   ...
                   <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                         ...
                         <input  name="added_by_name" type="text" class="form-control " placeholder="Added By Name" autocomplete="added_by_name" value="">
                    ...
                    <div class="col-lg-4">
                      <div class="input-block mb-3">
                        ...
                        <input  name="added_on_date" type="datetime-local" class="form-control " placeholder="Added On Date" value="" autocomplete="added_on_date">
                        <span class="text-danger added_on_date"></span>
                    </div>
                    </div>
                    <div class="col-lg-12">
                        <label for="basicpill-servicetax-input"  class="form-label">Notes</label>
                        <textarea name="notes" id="summernote2" cols="30" rows="10"></textarea>

                    </div>
                    <div class="col-lg-12">
                        <label for="basicpill-servicetax-input"  class="form-label">Placement</label>
                        <textarea name="placement" id="summernote3" cols="30" rows="10"></textarea>
                    </div>
                    <div class="col-lg-12">
                        <label for="basicpill-servicetax-input"  class="form-label">Accomodation Details</label>
                        <textarea name="accomodation_details" id="summernote4" cols="30" rows="10"></textarea>
                    </div>
                  </div>
                </form>
                <br>
