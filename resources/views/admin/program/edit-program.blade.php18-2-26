                       ...
                       <div class="form-floating">
                          <select class="form-control " name="school_id" id="school_id" placeholder="University / College Name">
                            ...
                            @foreach ($universities as $item)
                               <option value="{{$item->id}}" {{ old('school_id') == $item->id ? 'selected' : ($program->school_id == $item->id ? 'selected' : '') }}>{{ implode(' ', array_slice(explode(' ', $item->university_name), 0, 10)) }}</option>
                            @endforeach
                         </select>
                   ...
                   <div class="col-4">
                        <div class="form-floating">
                            <input id="lead-application_closing_date_input" 
                                ...
                                autocomplete="application_closing_date"
                                value="{{ old('application_closing_date_input', (is_numeric(strtotime($program->application_closing_date ?? '')) ? $program->application_closing_date : '')) }}">
                            <label for="lead-application_closing_date_input" class="form-label">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" 
                                ...
                                value="ASAP" 
                                {{ old('application_closing_date', $program->application_closing_date) == 'ASAP' ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" 
                                ...
                                value="TBD" 
                                {{ old('application_closing_date', $program->application_closing_date) == 'TBD' ? 'checked' : '' }}>
                            <label class="form-check-label" for="application_closing_date_option2">TBD</label>
                        </div>

                        <!-- Hidden field to actually submit -->
                        <input type="hidden" name="application_closing_date" id="application_closing_date_hidden"
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            $('.date-input').on('change', function() {
                                $('#application_closing_date_hidden').val($(this).val());
                                $('input[name="application_closing_date_radio"]').prop('checked', false); // uncheck radios
                            });

                            // When radio changes
                            $('input[name="application_closing_date_radio"]').on('change', function() {
                                $('#application_closing_date_hidden').val($(this).val());
                                if ($(this).val() === 'ASAP' || $(this).val() === 'TBD') {
                                    $('.date-input').val('');
                                }
                            });
                        });
