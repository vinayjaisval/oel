                    ...
                    <div class="wizard">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" role="tabpanel" id="step1"
                                ...
                                @endif
                                <form class="row g-4" action="{{ route('update-documents',$document->id) }}" method="POST"
                                ...
                                @csrf
                                    ...
                                    <div class="col-12">
                                        ...
                                        @php
                                            $programlevels =App\Models\ProgramLevel::get();
                                        @endphp
                                        <select class="form-control " name="program_level_id">
                                            <option value="">Select Program Level</option>
                                            @foreach ($programlevels as $item)
                                                <option value="{{ $item->id }}" {{ ($document->program_level_id == $item->id) ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
