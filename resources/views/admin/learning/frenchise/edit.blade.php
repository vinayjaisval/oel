        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0"> Edit Franchise </h4>
                </div>
                <div class="card-body">
                    <div class="wizard">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" role="tabpanel" id="step1"
                                ...
                                @endif
                                <form class="row g-4" action="{{ route('learning-franchise.update', $data->id) }}" method="POST"
                                    ...
                                    <div class="col-12" style="display: none">
                                        ...
                                        <input type="text" class="form-control " name="learning_user" value="franchise">
                                        @error('learning_user')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
