                ...
                <div class="col-md-12">
                    <ol class="breadcrumb text-muted mb-0">
                        <li class="breadcrumb-item">
                            <a href="index.php"> Sub Agent </a>
                        </li>
                        <li class="breadcrumb-item text-muted">Sub Agent List</li>
                    </ol>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control formmrgin " name="phone_number"
                                value="{{ request()->get('phone') }}" placeholder=" Phone Number" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);">
                        </div>
                        <div class="col-md-4">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.send_sms').on('click', function() {
                ...
                $.ajax({
                    url: "{{route('send-sms-sub-agent')}}",
                    method: 'Post',
                    data: {
                        leadIds: selectedLeads,
                        template_id: template_id,
                        custom_templete: custom_templete
                    },
            ...
            $('.send_email').on('click', function() {
                ...
                $.ajax({
                    url: "{{ route('send-email-sub-agent') }}",
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
