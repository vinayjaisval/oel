                    ...
                    <div class="wizard">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" role="tabpanel" id="step1"
                                ...
                                <form class="row " action="{{ route('update-testimonial',$testimonial->id) }}" method="POST"
                                    ...
                                    <div class="col-md-4 input-group-adss ">
                                     ...
                                     <div class="col-md-4 input-group-adss ">
                                        ...
                                        <input type="text" class="form-control " name="review_link" value="{{ $testimonial->review_link }}" placeholder="Enter Review link">
                                        @error('review_link')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                     ...
                                     <div class="col-md-4 input-group-adss ">
                                        ...
                                        <input type="text" class="form-control " name="meta_tags" value="{{ $testimonial->meta_tags }}" placeholder="Enter Meta Tags">
                                        @error('meta_tags')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                     <div class="col-md-12 input-group-adss">
                                        ...
                                        <textarea name="meta_description" id="summernote2" style="visibility: hidden; display: none;">{{ old('testimonial_desc', $testimonial->meta_description) }}</textarea>
