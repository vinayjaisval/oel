                ...
                <div class="uk-inner">
                    <div class="uk-hero-grid">
                        <div class="uk-hero-content">
                            <span class="uk-badge">STUDY IN SOUTH KOREA &middot; 2027 INTAKE</span>
                             ...
                             @forelse($universities as $university)
                                <div class="uk-card uk-uni-card">
                                    <div class="uk-uni-logo">
                                        @if($university->logo)
                                            <img src="{{ asset($university->logo) }}" alt="{{ $university->university_name }} logo" loading="lazy">
                                        @endif
                                    </div>
                                    <h4>{{ $university->university_name }}</h4>
                                    <p>{{ $university->university_location ?: $university->city ?: 'United Kingdom' }}</p>
                                    <a href="#register-form" class="uk-mini-link">Explore &rarr;</a>
                                </div>
                            @empty
                                <p class="uk-text-center">No UK universities are available at the moment.</p>
                            @endforelse
                        </div>
