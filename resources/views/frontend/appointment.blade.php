...
<section>
    <div class="university_title ">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="attractive-bar">
                                <img src="http://127.0.0.1:8000/frontend/img/Group 271.png" alt="gif">"
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="universities_heading ">
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    <input type="text" class="form-control delete  rounded" placeholder="First name" aria-label="First name">
                                </div>
                                <div class="col-lg-12 mb-3">
                                    <input type="text" class="form-control delete  rounded" placeholder="Last name" aria-label="Last name">
                                </div>
                                <div class="col-lg-4 mb-3">
                                    <input type="" class="form-control delete rounded" placeholder="91+" aria-label="Last name">
                                </div>
                                <div class="col-lg-8 mb-3">
                                    <input type="Number" class="form-control delete rounded" placeholder="Mobile Number" aria-label="Mobile Number">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    <select class="form-select " id="inputGroupSelect01">
                                        <option selected>Preferred Study Year</option>
                                        <option value="1">One</option>
                                        <option value="2">Two</option>
                                        <option value="3">Three</option>
                                    </select>
                                ...
                                <div class="input-group mb-3">
                                    <select class="form-select " id="inputGroupSelect01">
                                        <option selected>Preferred Study Intake</option>
                                        <option value="1">One</option>
                                        <option value="2">Two</option>
                                        <option value="3">Three</option>
                                    </select>
                                ...
                                <div class="free-code text-center mt-3">
                                    <button class="apply-btn fn border-0 px-4 py-2">Get Started for Free</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="connect-with-title pb-5 ">
            <h4 class="pt-4 pb-4 text-center fw-medium p-10">Connect with Us</h4>
            <div class="connect-text mx-auto">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mobile-text bg-white">
                            <div class="text-number">
                                <img src="http://127.0.0.1:8000/frontend/img/2.png.png" width="65" height="65" alt="telephone">
                            </div>
                            <div class="text-mobi px-3 py-5">
                                <p class="mt-3">Call our toll-free number</p>
                                <span>+91-81308 39777</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mobile-text bg-white">
                            <div class="text-number ">
                                <img src="http://127.0.0.1:8000/frontend/img/Mail.png" width="100" height="65" alt="mailbox">
                            </div>
                            <div class="text-mobi px-3 py-5">
                                <p class="mt-3">Book an appointment</p>
                                <span>info@overseaseducationlane.com</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="info-title pt-5 pb-5">
        <div class="row">
            <div class="col-lg-6">
                <div class="noida-title-address p-3">
                    ...
                    <div class="location-visit mb-4 d-flex gap-4">
                        ...
                        <span class="fw-bold">Corporate office
                            A 12-13,2nd Floor, Sector 16 Noida, Uttar Pradesh, 201301</span>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="noida-title-address p-3">
                    <div class="head-text-noida text-center">
                        <p class="fw-bold"> Gorakhpur</p>
                    </div>
                    <div class="location-visit mb-4 d-flex gap-4">
                        <i class="fa fa-map-marker" aria-hidden="true"></i>
                        <span class="fw-bold">22/ A Parha mohaddipur P. O Railway colony Gorakhpur 273008</span>
                    </div>
                    <div class="google-title mb-4">
                        <span class="fw-bold">Open on Google Maps</span>
                    </div>
