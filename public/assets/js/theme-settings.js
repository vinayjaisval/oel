!(function () {
    ...
    sessionStorage.getItem("defaultAttribute")
        ...
        a[0].addEventListener("click", function (a) {
            p.hasAttribute("data-layout-mode") && "dark" == p.getAttribute("data-layout-mode") ? H("data-layout-mode", "light", "layout-mode-light", p) : H("data-layout-mode", "dark", "layout-mode-dark", p);
        }),
